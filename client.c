...
int init_socket(struct sockaddr_in *sin)
{
    ...
    inet_pton(AF_INET, "79.22.156.194", &sin->sin_addr); // this will create a big endian 32 bit address
...
// Entry point ------------------------------------------------------------
int send_packet(const int s, const unsigned int message_type, const unsigned int message_id, const unsigned int p_id, const float x, const float y, struct sockaddr_in *sin)
{
    // Init packet struct
    maze_packet packet;
